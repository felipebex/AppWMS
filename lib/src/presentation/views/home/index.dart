          ...
          return RefreshIndicator(
            ...
            child: MultiBlocListener(
              listeners: [
                ...
                //*listener de packing
                BlocListener<WmsPackingBloc, WmsPackingState>(
                    listener: (context, state) {
                  print('state $state');
                  if (state is WmsPackingWMSLoading) {
                    showDialog(
                      context: context,
                      barrierDismissible: false,
                      builder: (context) => const DialogLoading(
                  ...
                  if (state is WmsPackingLoadedBD) {
                    Navigator.pop(context);
                  }
                }),

                //*listener de transferencia
                BlocListener<TransferenciaBloc, TransferenciaState>(
                  listener: (context, state) {
                ...
                //*listener de recepcion
                BlocListener<RecepcionBloc, RecepcionState>(
                  listener: (context, state) {

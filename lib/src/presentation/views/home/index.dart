...
import 'package:wms_app/src/presentation/views/inventario/screens/widgets/dialog_almacenes_widget.dart';
                                          ...
                                          onTap: () async {
                                            if (homeBloc.userRol ==
                                              ...
                                              context.read<TransferenciaBloc>().add(
                                                  FetchAllTransferenciasDB()); // L
                                              //cargamos las novedades para este modulo
                                              context.read<TransferenciaBloc>().add(
                                                  LoadAllNovedadesTransferEvent()); // L
                                            ...
                                            if (homeBloc.userRol ==
                                              ...
                                              if (context
                                                ...
                                                showDialog(
                                                  context: context,
                                                  builder: (context) {
                                                    return const DialogAlmacenes();
                                                  },
                                                ).then((selectedId) async {
                                                  if (selectedId != null) {
                                                    print(
                                                        "ID warehouse: $selectedId");

...
class SearchLoteCreateTransferScreen extends StatefulWidget {
  const SearchLoteCreateTransferScreen({super.key, this.currentProduct});

  final Product? currentProduct;

  @override
  State<SearchLoteCreateTransferScreen> createState() => _NewLoteScreenState();
}

class _NewLoteScreenState extends State<SearchLoteCreateTransferScreen> {
  bool viewList = true;

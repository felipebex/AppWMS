                    ...
                    Row(
                      children: [
                        ...
                        Align(
                            alignment: Alignment.centerLeft,
                            child: Text(
                              batchModel?.userId == false || batchModel?.userId == ""
                                  ? 'Sin responsable'
                                  : "${batchModel?.userId}",
                              style: const TextStyle(
              ...
              builder: (context, state) {
                ...
                return Expanded(
                  ...
                  child: ListView.builder(
                      itemCount: packingBloc.listPacking.length,
                      itemBuilder: (context, index) {
                        final packing = packingBloc.listPacking[index];

...
class MuelleOrderDropdownWidget extends StatefulWidget {
  final String? selectedMuelle;
  final LineasRecepcion currentProduct;
  final bool isPda;

  const MuelleOrderDropdownWidget({
    super.key,
  ...
  @override
  State<MuelleOrderDropdownWidget> createState() =>
      _MuelleDropdownWidgetState();
}

class _MuelleDropdownWidgetState extends State<MuelleOrderDropdownWidget> {
  @override
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButton<String>(
            ...
            items: [
              DropdownMenuItem(
                ...
                child: Text(
                  widget.currentProduct.locationDestName.toString(),
          ...
          Align(
            alignment: Alignment.centerLeft,
            child: Visibility(
              visible: widget.currentProduct.locationDestBarcode == null ||
                  widget.currentProduct.locationDestBarcode == "" ||
                  widget.currentProduct.locationDestBarcode == false,
              child: const Padding(

                                        ...
                                        children: [
                                          Center(
                                            child: DropdownButton<String>(
                                              ...
                                              onChanged: batchBloc.locationIsOk
                                                  ? null
                                                  : (String? newValue) {
                                                      if (newValue ==
                                                          currentProduct
                          ...
                          child: Center(
                            child: Row(
                              children: [
                                                ...
                                                if (scannedValue3.isNotEmpty) {
                                                  ...
                                                  if (scannedValue3
                                                    ...
                                                    if (quantity ==
                                                      ...
                                                      // Esperar 1 segundos y cerrar el diálogo
                                ...
                                IconButton(
                                    onPressed:
                                        batchBloc.quantityIsOk && quantity > 0
                                            ? () {
                                                setState(() {
                          ...
                          onPressed: batchBloc.quantityIsOk && quantity > 0
                              ? () {
                                  ...
                                  if (cantidad < currentProduct!.quantity) {
                                    print(
                                        "es menor: $cantidad a ${currentProduct.quantity}");
                                    showDialog(
                                        context: context,
                                        builder: (context) {
                                          return DialogAdvetenciaCantidadScreen(
                                    ...
                                    print(
                                        "es mayor: $cantidad a ${currentProduct.quantity}");
                                    ScaffoldMessenger.of(context)
                                        .showSnackBar(SnackBar(
                                      duration:

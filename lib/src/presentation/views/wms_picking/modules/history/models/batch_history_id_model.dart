...
class HistorBatchId {
  ...
  factory HistorBatchId.fromJson(String str) =>
      HistorBatchId.fromMap(json.decode(str));
  ...
  factory HistorBatchId.fromMap(Map<String, dynamic> json) => HistorBatchId(
        ...
        result: json["result"] == null
            ? null
            : HistorBatchIdResult.fromMap(json["result"]),
      );
...
class HistorBatchIdResult {
  ...
  factory HistorBatchIdResult.fromJson(String str) =>
      HistorBatchIdResult.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory HistorBatchIdResult.fromMap(Map<String, dynamic> json) =>
      HistorBatchIdResult(
        code: json["code"],
        result: json["result"] == null
            ? null
            : HistoryBatchId.fromMap(json["result"]),
      );
...
class HistoryBatchId {
  ...
  factory HistoryBatchId.fromJson(String str) =>
      HistoryBatchId.fromMap(json.decode(str));
  ...
  factory HistoryBatchId.fromMap(Map<String, dynamic> json) => HistoryBatchId(
        ...
        listItems: json["list_items"] == null
            ? []
            : List<ListItem>.from(
                json["list_items"]!.map((x) => ListItem.fromMap(x))),

...
class DialogRecepBatchAdvetenciaCantidadScreen extends StatefulWidget {
  const DialogRecepBatchAdvetenciaCantidadScreen({
    super.key,
  ...
  @override
  State<DialogRecepBatchAdvetenciaCantidadScreen> createState() =>
      _DialogAdvetenciaCantidadScreenState();
}

class _DialogAdvetenciaCantidadScreenState
    extends State<DialogRecepBatchAdvetenciaCantidadScreen> {

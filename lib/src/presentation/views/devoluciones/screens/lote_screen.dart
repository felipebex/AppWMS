...
class NewLoteScreenDevolucion extends StatefulWidget {
  ...
  @override
  State<NewLoteScreenDevolucion> createState() => _NewLoteScreenState();
}

class _NewLoteScreenState extends State<NewLoteScreenDevolucion> {
  bool viewList = true;
                      ...
                      return Container(
                        ...
                        child:
                          ...
                          if (state is CreateLoteProductSuccess) {
                            Get.snackbar(
                              'Lote Creado',
                              'Has creado el lote: ${state.loteProduct.name}',
                              backgroundColor: white,
...
// 1. Obtener el dato crudo
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          var selectedLote = context
                              .read<DevolucionesBloc>()
                              .listLotesProduct[selectedIndex!];
                  ...
                  Visibility(
                    visible:
                        !context.read<DevolucionesBloc>().isKeyboardVisible,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ElevatedButton(

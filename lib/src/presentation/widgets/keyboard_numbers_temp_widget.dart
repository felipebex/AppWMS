...
class CustomKeyboardTempNumber extends StatefulWidget {
  final TextEditingController controller;
  final VoidCallback onchanged;
  final bool isDialog;

  const CustomKeyboardTempNumber({
    super.key,
...
class _CustomKeyboardNumberState extends State<CustomKeyboardTempNumber> {
